...
function InfoItem({ data, dataType, theme }) {
    ...
    return (     
        <div className={style['flex-container']}>
            ...
            <div className={style['flex-item']} style={{ height:'auto'}}>
                <span style={{ color:theme === 'dark' ? 'rgba(255,255,255,0.7)' : 'rgba(0, 0, 0, 0.8)', fontSize:'0.8rem' }}>
                    {
                ...
                <br/>
                <span className={style['data']} >{Math.floor(+value)}</span><span style={{ color:theme === 'dark' ? 'rgba(255,255,255,0.7)' : 'rgba(0, 0, 0, 0.8)', fontSize:'0.8rem', margin:'0 6px'}}>{ dataType === '1' ? '元' : 'kwh' }</span>
            </div>  
            <div className={style['flex-item']} style={{ height:'auto'}}>
                <span style={{ color:theme === 'dark' ? 'rgba(255,255,255,0.7)' : 'rgba(0, 0, 0, 0.8)', fontSize:'0.8rem' }}>同比</span>
                <br/>
                {
                    !same
                    ?
            ...
            <div className={style['flex-item']} style={{ height:'auto'}}>
                <span style={{ color:theme === 'dark' ? 'rgba(255,255,255,0.7)' : 'rgba(0, 0, 0, 0.8)', fontSize:'0.8rem' }}>环比</span>
                <br/>
                {
                    !last
                    ?
