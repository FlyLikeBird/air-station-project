...
let scene;
function SceneMonitor({ dispatch, currentCompany, currentScene, sceneIndex }){
                        ...
                        if ( airMachMaps[target.name] ){
                            ...
                            if ( eleMachMaps[target.name] ) {
                                ...
                                Promise.all([
                                    ...
                                    new Promise((resolve, reject)=>{
                                        dispatch({ type:'home/fetchAirMachData', payload:{ mach_type:'ele', register_code:eleMachMaps[target.name], resolve, reject }})
                                    })
                                ])
